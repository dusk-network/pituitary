...
// Schema migration functions for V4-V7 were removed: they were never wired into
// the update eligibility chain, so every sub-V10 index already falls through to
// a full rebuild. Reintroduce them alongside a proper `applyPendingMigrations`
// driver when incremental upgrades from older schemas become a supported flow.
