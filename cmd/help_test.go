...
func TestRunCommandHelpAcrossSurface(t *testing.T) {
	...
	testCases := map[string][]string{
		...
		"status":            {"usage: pituitary [--config PATH] status [--format FORMAT] [--check-runtime SCOPE] [--compact]", "shared config resolution:", "--format VALUE", "--check-runtime VALUE", "--compact"},
		...
		"check-terminology": {"usage: pituitary [--config PATH] check-terminology ([--term TERM]... [--canonical-term TERM]... [--spec-ref REF | --path PATH] [--scope SCOPE] [--include-semantic-matches] | --request-file PATH|-) [--format FORMAT]", "shared config resolution:", "--term VALUE", "--canonical-term VALUE", "--scope VALUE", "--request-file VALUE", "--include-semantic-matches"},
